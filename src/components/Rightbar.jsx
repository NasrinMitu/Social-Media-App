    ...
    return (
        ...
        sx={{display:{xs:'none', sm:'block'}}}>
            <Box position="fixed" width={300}>
                ...
                <AvatarGroup max={4}>
                     <Avatar alt="Remy Sharp" src="/img/avatar.jpg" />
                     <Avatar alt="Travis Howard" src="/img/avatar.jpg" />
                     <Avatar alt="Cindy Baker" src="/img/avatar.jpg" />
                     <Avatar alt="Agnes Walker" src="/img/avatar.jpg" />
                     <Avatar alt="Trevor Henderson" src="/img/avatar.jpg" />
                </AvatarGroup>
